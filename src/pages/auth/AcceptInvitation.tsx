...
type ViewState = "loading" | "valid" | "not_found" | "expired" | "used" | "error";
          ...
          <>
            ...
            <p className="mt-2 text-sm leading-6 text-clinic-muted">
              {invitation.emailHasAccount
                ? "Ya tenés una cuenta en Medin. Confirmá para asociarte a esta clínica con el rol indicado."
                : "Creá tu contraseña para activar tu acceso a Medin."}
            </p>
