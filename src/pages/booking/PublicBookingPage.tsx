  ...
  return (
    <main className="min-h-screen bg-[#f6faf9] px-4 py-4 text-[#0d3642] sm:px-6 lg:py-8">
      <header className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-5 rounded-2xl border border-[#dcebea] bg-white px-5 py-4 shadow-sm sm:px-8">
        ...
        <div className="flex gap-4 text-sm font-medium text-[#0d3642]"><span className="flex items-center gap-2"><ShieldCheck size={19}/>Tus datos están protegidos</span><span className="hidden items-center gap-2 sm:flex"><MessageCircle size={19}/>Canales de la clínica</span></div>
      </header>
